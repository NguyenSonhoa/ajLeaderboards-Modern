...
import us.ajg0702.leaderboards.displays.holograms.ResetBar;
...
public class LeaderboardPlugin extends JavaPlugin {
    ...
    public void onDisable() {
        ...
        shuttingDown = true;
        if(resetBar != null) resetBar.stop();
